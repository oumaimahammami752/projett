...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> makeReservation(
            ...
            @RequestParam String garniture,
            @RequestParam String dessert,
            @RequestParam String sandwich) {

        Reservation reservation = reservationService.makeReservation(userId, reservationDate, entree, suite, garniture, dessert, sandwich);
    ...
    public ResponseEntity<List<Map<String, Object>>> getAllReservations() {
        ...
        List<Map<String, Object>> response = reservations.stream().map(reservation -> {
            ...
            reservationData.put("entree", reservation.getEntree());
            reservationData.put("suite", reservation.getSuite());
            reservationData.put("dessert", reservation.getDessert());
            reservationData.put("garniture", reservation.getGarniture());
            reservationData.put("sandwitch", reservation.getSandwich());
